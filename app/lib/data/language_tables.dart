...
const languageTables = <LanguageTable>[
  ...
  LanguageTable(
    ...
    cards: [
      LanguageCard(id: 'comp-1', text: 'Relax your eyes', category: CardCategory.red, tableName: 'Compliance Commands'),
      LanguageCard(id: 'comp-2', text: 'Make yourself comfortable', category: CardCategory.red, tableName: 'Compliance Commands'),
      LanguageCard(id: 'comp-3', text: 'Let your breathing settle', category: CardCategory.red, tableName: 'Compliance Commands'),
      LanguageCard(id: 'comp-4', text: 'In a moment, I\'m going to ask you to relax', category: CardCategory.red, tableName: 'Compliance Commands'),
      LanguageCard(id: 'comp-5', text: 'Take a comfortable breath', category: CardCategory.red, tableName: 'Compliance Commands'),
      LanguageCard(id: 'comp-6', text: 'Allow your shoulders to relax', category: CardCategory.red, tableName: 'Compliance Commands'),
      LanguageCard(id: 'comp-7', text: 'Notice the support beneath you', category: CardCategory.red, tableName: 'Compliance Commands'),
      LanguageCard(id: 'comp-8', text: 'Let your hands rest comfortably', category: CardCategory.red, tableName: 'Compliance Commands'),
      LanguageCard(id: 'comp-9', text: 'Take a moment to settle in', category: CardCategory.red, tableName: 'Compliance Commands'),
      LanguageCard(id: 'comp-10', text: 'Find a comfortable position', category: CardCategory.red, tableName: 'Compliance Commands'),
      LanguageCard(id: 'comp-11', text: 'Allow yourself to listen', category: CardCategory.red, tableName: 'Compliance Commands'),
      LanguageCard(id: 'comp-12', text: 'Just let your eyes rest', category: CardCategory.red, tableName: 'Compliance Commands'),
    ],
  ),
  LanguageTable(
